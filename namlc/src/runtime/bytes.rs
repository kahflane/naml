...
#[unsafe(no_mangle)]
pub extern "C" fn naml_bytes_new(capacity: usize) -> *mut NamlBytes {
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn naml_bytes_from(data: *const u8, len: usize) -> *mut NamlBytes {
    unsafe {
...
/// Get bytes length
#[unsafe(no_mangle)]
pub extern "C" fn naml_bytes_len(b: *const NamlBytes) -> i64 {
    if b.is_null() {
        0
    } else {
        unsafe { (*b).len as i64 }
...
/// Get byte at index
#[unsafe(no_mangle)]
pub extern "C" fn naml_bytes_get(b: *const NamlBytes, index: i64) -> i64 {
    if b.is_null() {
        return 0;
    }
    unsafe {
...
/// Set byte at index
#[unsafe(no_mangle)]
pub extern "C" fn naml_bytes_set(b: *mut NamlBytes, index: i64, value: i64) {
    if b.is_null() {
        return;
    }
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn naml_bytes_incref(b: *mut NamlBytes) {
    if !b.is_null() {
...
#[unsafe(no_mangle)]
pub extern "C" fn naml_bytes_decref(b: *mut NamlBytes) {
    if !b.is_null() {
        unsafe {
            if (*b).header.decref() {
                let cap = (*b).capacity;
...
#[unsafe(no_mangle)]
pub extern "C" fn naml_bytes_to_string(b: *const NamlBytes) -> *mut NamlString {
    if b.is_null() {
...
#[unsafe(no_mangle)]
pub extern "C" fn naml_string_to_bytes(s: *const NamlString) -> *mut NamlBytes {
    if s.is_null() {
        return naml_bytes_new(0);
    }
    unsafe {
        let len = (*s).len;
