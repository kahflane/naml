...
#[unsafe(no_mangle)]
pub extern "C" fn naml_array_new(capacity: usize) -> *mut NamlArray {
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn naml_array_from(values: *const i64, len: usize) -> *mut NamlArray {
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn naml_array_incref(arr: *mut NamlArray) {
    if !arr.is_null() {
...
/// Get array length
#[unsafe(no_mangle)]
pub extern "C" fn naml_array_len(arr: *const NamlArray) -> i64 {
    if arr.is_null() {
        0
    } else {
...
#[unsafe(no_mangle)]
pub extern "C" fn naml_array_get(arr: *const NamlArray, index: i64) -> i64 {
    if arr.is_null() {
        return 0;
    }
...
#[unsafe(no_mangle)]
pub extern "C" fn naml_array_set(arr: *mut NamlArray, index: i64, value: i64) {
    if arr.is_null() {
        return;
    }
...
#[unsafe(no_mangle)]
pub extern "C" fn naml_array_push(arr: *mut NamlArray, value: i64) {
    if arr.is_null() {
        return;
    }
...
#[unsafe(no_mangle)]
pub extern "C" fn naml_array_pop(arr: *mut NamlArray) -> i64 {
    if arr.is_null() {
        return 0;
    }
...
#[unsafe(no_mangle)]
pub extern "C" fn naml_array_contains(arr: *const NamlArray, value: i64) -> i64 {
    if arr.is_null() {
        return 0;
    }
...
#[unsafe(no_mangle)]
pub extern "C" fn naml_array_clone(arr: *const NamlArray) -> *mut NamlArray {
    if arr.is_null() {
...
#[unsafe(no_mangle)]
pub extern "C" fn naml_array_print(arr: *const NamlArray) {
    if arr.is_null() {
        print!("[]");
        return;
    }
